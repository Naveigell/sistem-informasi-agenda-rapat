...
@section('body')
    ...
    <div class="body-section-container">
        ...
        <div class="body-section">
            <h4>Nama Pimpinan</h4>
            <span>{{ $data->pimpinan['nama_pimpinan'] }} (Telp {{ $data->pimpinan['no_telepon'] }})</span> <br/>
        </div>
    </div>
        ...
        <div class="mail-container">
            <div class="mail-detail">
                <table>
                    <tr>
                        <td>Nomor surat</td>
                        <td>: {{ $data->surat['id_nomor_surat'] }}</td>
                    </tr>
                    <tr>
                        <td>Lampiran</td>
                        <td>: Surat Penting</td>
                    ...
                    <tr>
                        <td>Hal</td>
                        <td>: {{ $data->surat['perihal_surat'] }}</td>
                    </tr>
                </table>
            </div>
            <br/>
            ...
            <div class="mail-from" style="margin-top: 70px;">
                <div class="mail-from-text">
                    <span class="mail-from-position">
                        {{ $data->surat['jabatan_pengirim'] }}, <span class="main-from-date">{{ \Carbon\Carbon::parse($data->surat['tanggal_surat'])->format('d F Y') }}</span>
                    </span>
                    <span class="mail-from-name" style="display: block; margin-top: 120px;">{{ $data->surat['pengirim_surat'] }}</span>
                </div>
            </div>
        </div>
    </div>
