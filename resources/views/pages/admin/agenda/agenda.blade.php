...
@section('body')
    ...
    <div class="body-section logo-background">
            ...
            <tbody>
                @foreach($data as $agenda)
                    ...
                    <tr>
                        ...
                        <td class="col-md-3">
                            <a href="/admin/agenda/{{ $agenda->id_rapat }}" class="btn btn-md button-secondary" type="button" name="button">Detail</a>
                            <a href="/admin/agenda/{{ $agenda->id_rapat }}/edit" class="btn btn-md button-warning" type="button" name="button">Edit</a>
        ...
        <br/>
        <a class="btn btn-md button-success" href="/admin/agenda/insert">Tambah Agenda Baru</a>
    </div>
