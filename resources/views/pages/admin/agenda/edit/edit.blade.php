...
@section('styles')
{{--    <link rel="stylesheet" href="{{ url('/css/page/admin/agenda/edit.css') }}">--}}
...
@section('body')
    ...
    <div class="body-section">
        <form action="/api/admin/agenda/update" method="POST">
            @csrf
