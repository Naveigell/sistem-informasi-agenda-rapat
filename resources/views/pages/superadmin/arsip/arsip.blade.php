...
@section('body')
    ...
    <div class="body-section">
            ...
            <tbody>
                @foreach($arsip as $a)
                    <tr>
                        ...
                        <td class="col-md-3">
                            <a href="/superadmin/arsip/{{ $a->id_arsip_rapat }}" class="btn btn-md button-secondary" type="button" name="button">Lihat Hasil</a>
                            <a href="/superadmin/arsip/{{ $a->id_arsip_rapat }}/edit" class="btn btn-md button-warning" type="button" name="button">Edit Hasil</a>
        ...
        <br/>
        <a class="btn btn-md button-success" href="/superadmin/arsip/insert">Tambah Arsip Baru</a>
    </div>
        ...
        $(document).ready(function () {
            $('.btn-action-hapus').on('click', function (evt) {
                ...
                swal({
                    ...
                    $.ajax({
                        url: '/api/superadmin/arsip/delete',
                        method: 'POST',
                        data: {
                            id: id,
